...
# Taken from https://github.com/OSGeo/gdal/blob/master/cmake/modules/packages/FindPROJ.cmake
...
if(PROJ_FOUND)
    ...
    if(NOT TARGET PROJ::proj)
        ...
        set_target_properties(
            PROJ::proj PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${PROJ_INCLUDE_DIR}" IMPORTED_LINK_INTERFACE_LANGUAGES
                                                                                      "C"
        )
        if(EXISTS "${PROJ_LIBRARY}")
            set_target_properties(
                PROJ::proj PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES "C" IMPORTED_LOCATION "${PROJ_LIBRARY}"
            )
        endif()
        if(EXISTS "${PROJ_LIBRARY_RELEASE}")
            ...
            set_target_properties(
                PROJ::proj PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C" IMPORTED_LOCATION_RELEASE
        ...
        if(EXISTS "${PROJ_LIBRARY_DEBUG}")
            ...
            set_target_properties(
                PROJ::proj PROPERTIES IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C" IMPORTED_LOCATION_DEBUG
                                                                                  "${PROJ_LIBRARY_DEBUG}"
            )
        endif()
    endif()
